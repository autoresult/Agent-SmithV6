...
export default function ChatPage() {
        ...
        for (const part of parts) {
          ...
          try {
            ...
            if (data.token) {
              ...
              // ATUALIZAÇÃO DO ESTADO EM TEMPO REAL
              setMessages((prev) =>
                prev.map((msg) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#2f2f2f]">
      {userId && (
        <UnifiedSidebar
          userId={userId}
      ...
      <div className="flex-1 flex flex-col h-full lg:ml-64 relative">
        {/* HEADER DO CHAT */}
        <div className="h-16 border-b border-[#3f3f3f] bg-[#2f2f2f]/95 backdrop-blur supports-[backdrop-filter]:bg-[#2f2f2f]/60 flex items-center px-6 justify-between shrink-0 z-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-zinc-100">Conversando com</span>
                  <Badge
                    variant="outline"
                    className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 text-xs py-0.5 px-2 h-5"
                  >
                    {currentAgentName}
                  </Badge>
                </div>
        ...
        {/* ÁREA DE INPUT */}
        <div className="flex-shrink-0 bg-gradient-to-t from-[#2f2f2f] via-[#2f2f2f] to-transparent pt-6 pb-4 px-4 z-10 w-full">
          <div className="max-w-3xl mx-auto">
            ...
            />
            <div className="flex justify-center mt-2 items-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
              <p className="text-[10px] text-zinc-500 font-medium uppercase tracking-wider">
                Agente Ativo: <span className="text-emerald-500">{currentAgentName}</span>
              </p>
            </div>
          </div>
        </div>
