  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Visão geral do sistema Smith</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {statCards.map((card, index) => (
            <Card key={index} className="bg-[#1A1A1A] border-[#2D2D2D]">
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-[#1A1A1A] border-[#2D2D2D]">
          ...
          <CardContent className="space-y-3">
            <a
              ...
              className="block p-4 bg-[#2D2D2D] rounded-lg hover:bg-[#3D3D3D] transition-colors"
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white font-medium">Aprovar Usuários</h3>
                  <p className="text-sm text-gray-400">{stats.pendingUsers} pendentes</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white font-medium">Gerenciar Empresas</h3>
                  <p className="text-sm text-gray-400">{stats.totalCompanies} cadastradas</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white font-medium">Ver Logs do Sistema</h3>
        ...
        <Card className="bg-[#1A1A1A] border-[#2D2D2D]">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2 border-b border-[#2D2D2D]">
              <span className="text-gray-400">Usuários Pendentes</span>
            ...
            <div className="flex items-center justify-between py-2">
              <span className="text-gray-400">Empresas Suspensas</span>
        ...
        <Card className="bg-[#1A1A1A] border-[#2D2D2D]">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-[#0A0A0A] rounded-lg border border-[#2D2D2D]">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Total de Logs</span>
                  <FileText className="w-5 h-5 text-cyan-500" />
                </div>
                <p className="text-3xl font-bold text-white">{stats.logsLast24h}</p>
                <p className="text-xs text-gray-500 mt-1">Eventos registrados</p>
              </div>

              <div className="p-4 bg-[#0A0A0A] rounded-lg border border-[#2D2D2D]">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Logins Falhados</span>
                  <AlertCircle className="w-5 h-5 text-yellow-500" />
                </div>
                <p className="text-3xl font-bold text-yellow-400">{stats.failedLoginsLast24h}</p>
                <p className="text-xs text-gray-500 mt-1">Tentativas sem sucesso</p>
              </div>

              <div className="p-4 bg-[#0A0A0A] rounded-lg border border-[#2D2D2D]">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Erros do Sistema</span>
