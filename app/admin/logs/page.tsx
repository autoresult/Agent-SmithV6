  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Visualize todos os logs e atividades do sistema Smith</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-[#2D2D2D] border-[#3D3D3D] text-white placeholder:text-gray-500"
              />
            </div>
            ...
            <Select value={dateFilter} onValueChange={setDateFilter}>
              ...
              <SelectContent className="bg-[#2D2D2D] border-[#3D3D3D]">
                ...
                <SelectItem value="90days" className="text-white">
                  Últimos 90 dias
                </SelectItem>
              </SelectContent>
            </Select>
            ...
            <Select value={actionFilter} onValueChange={setActionFilter}>
              ...
              <SelectContent className="bg-[#2D2D2D] border-[#3D3D3D] max-h-[300px]">
      ...
      {loading ? (
        <div className="text-white text-center py-12">Carregando logs...</div>
      ) : (
        <>
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                        <div>
                          ...
                          <span className="text-white">{getUserDisplay(log)}</span>
                        </div>
                        <div>
                          <span className="text-gray-400">Empresa: </span>
                          <span className="text-white">{getCompanyDisplay(log)}</span>
                        </div>
                        {log.ip_address && (
                          <div>
                            <span className="text-gray-400">IP: </span>
                            <span className="text-white font-mono text-xs">{log.ip_address}</span>
                          </div>
                        )}
                      </div>
                      ...
                      {expandedLog === log.id && (
                        <div className="mt-3 p-3 bg-[#0A0A0A] rounded border border-[#2D2D2D]">
            ...
            {filteredLogs.length === 0 && (
              <Card className="bg-[#1A1A1A] border-[#2D2D2D]">
                <CardContent className="py-12 text-center">
                  ...
                  <h3 className="text-white font-medium mb-2">Nenhum log encontrado</h3>
          ...
          {totalPages > 1 && (
            <div className="mt-6 flex items-center justify-center gap-2">
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-transparent border-[#3D3D3D] text-gray-400 hover:text-white hover:bg-[#2D2D2D] disabled:opacity-50"
              >
                Anterior
              </Button>
