  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Conecte canais de comunicação ao seu agente</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-[#1A1A1A] border-[#2D2D2D] opacity-50">
          <CardHeader>
            <CardTitle className="text-white flex items-center gap-2">
          ...
          <CardContent>
            <p className="text-gray-400 text-sm">Em breve: Integração com Telegram</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#1A1A1A] border-[#2D2D2D] opacity-50">
          ...
          <CardContent>
            <p className="text-gray-400 text-sm">Em breve: Integração com Facebook Messenger</p>
          </CardContent>
        </Card>
      </div>
    </div>
