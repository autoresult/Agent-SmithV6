...
import { Check, X, Star, TrendingUp, Calendar, Zap, MessageSquare, BarChart3 } from 'lucide-react';
    ...
    <div className="p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Gerencie sua assinatura e acompanhe seu consumo</p>
        </div>
        ...
        {loading ? (
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="bg-[#1A1A1A] border border-[#2D2D2D] p-1">
              <TabsTrigger
                value="planos"
              ...
              {subscription?.has_subscription && subscription.plan && (
                <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-2xl p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-black/30 rounded-lg p-3">
                      <p className="text-sm text-gray-400">Bases de Conhecimento</p>
                      <p className="text-xl font-bold text-white">
            ...
            <TabsContent value="consumo" className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-[#1A1A1A] border border-[#2D2D2D] rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-blue-900/30 to-blue-800/20 border border-blue-500/30 rounded-xl p-5">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-gray-400 text-sm">Créditos Usados</span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/20 border border-purple-500/30 rounded-xl p-5">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-gray-400 text-sm">Chamadas</span>
                  </div>
                  <p className="text-2xl font-bold text-white">{formatNumber(totalCalls)}</p>
                  <p className="text-xs text-gray-500 mt-1">requisições à API</p>
                </div>

                <div className="bg-gradient-to-br from-emerald-900/30 to-emerald-800/20 border border-emerald-500/30 rounded-xl p-5">
                  <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">tokens processados</p>
                </div>
              </div>
              ...
              {dailyUsage && dailyUsage.daily.length > 0 && (
                <div className="bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-white mb-4">📈 Consumo Diário</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* By Service */}
                <div className="bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-white mb-4">⚙️ Por Serviço</h3>
                ...
                {/* By Agent */}
                <div className="bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-white mb-4">👥 Por Agente</h3>
