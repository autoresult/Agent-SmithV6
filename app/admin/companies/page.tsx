    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Visualize e gerencie todas as empresas cadastradas</p>
        </div>
          ...
          <DialogContent className="bg-[#1A1A1A] border-[#2D2D2D] text-white max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="legal_name" className="text-gray-300">
                    Razão Social
                  </Label>
                  <Input
                    id="legal_name"
              ...
              <div>
                <Label htmlFor="max_users" className="text-gray-300">
                ...
                <Input
                  ...
                  className="bg-[#2D2D2D] border-[#3D3D3D] text-white w-32"
                />
              </div>

              {/* Seção Endereço com CEP */}
              <div className="border-t border-[#2D2D2D] pt-4">
                <h3 className="text-white font-medium mb-3">Endereço</h3>
                <div className="space-y-3">
                  <div className="grid grid-cols-4 gap-4">
                    <div className="col-span-1">
                      <Label htmlFor="cep" className="text-gray-300">
                        CEP
                      </Label>
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1">
                      <Label htmlFor="complement" className="text-gray-300">
                        Complemento
                      </Label>
                      <Input
                        id="complement"
              ...
              <div className="border-t border-[#2D2D2D] pt-4">
                <h3 className="text-white font-medium mb-3">Contato Principal</h3>
                <div className="space-y-3">
                  <div>
                    <Label htmlFor="primary_contact_name" className="text-gray-300">
                      Nome
                    </Label>
                    <Input
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="primary_contact_email" className="text-gray-300">
                        Email
                      </Label>
                      <Input
                    ...
                    <div>
                      <Label htmlFor="primary_contact_phone" className="text-gray-300">
                        Telefone
                      </Label>
                      <Input
              ...
              <div className="flex gap-2 pt-4">
                ...
                <Button
                  onClick={closeDialog}
                  variant="outline"
                  className="flex-1 bg-transparent border-[#3D3D3D] text-gray-400 hover:text-white hover:bg-[#2D2D2D]"
                >
                  Cancelar
                </Button>
              </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {companies.map((company) => (
            <Card key={company.id} className="bg-[#1A1A1A] border-[#2D2D2D]">
              <CardHeader>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        <CardTitle className="text-white text-xl">{company.company_name}</CardTitle>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <p className="text-xs text-gray-400 mb-1">Máx. Administradores</p>
                    <p className="text-white font-medium">{company.max_users || 5}</p>
                  </div>
                  <div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="bg-transparent border-blue-600/50 text-blue-400 hover:text-blue-300 hover:bg-blue-600/10"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="bg-transparent border-purple-600/50 text-purple-400 hover:text-purple-300 hover:bg-purple-600/10"
                  >
        ...
        <DialogContent className="bg-[#1A1A1A] border-[#2D2D2D] text-white">
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-400">
              Empresa: <span className="text-white font-medium">{inviteCompany?.company_name}</span>
            </p>
            ...
            {!inviteLink ? (
              <>
                ...
                <div className="space-y-2">
                  <Label className="text-white">Email do Administrador *</Label>
                  <Input
                    type="email"
                ...
                {/* Name Input */}
                <div className="space-y-2">
                  <Label className="text-white">Nome (Opcional)</Label>
                  <Input
                    type="text"
                ...
                <div className="space-y-3">
                  <Label className="text-white">Tipo de Administrador</Label>
                  <div className="space-y-2">
                    <label className="flex items-center gap-3 p-3 bg-[#0D0D0D] rounded-lg border border-[#2D2D2D] cursor-pointer hover:border-purple-500/50 transition-colors">
                      <input
                        type="radio"
                        name="adminType"
                        value="regular"
                      ...
                      <div className="flex-1">
                        <p className="text-white font-medium">⚙️ Administrador Regular</p>
                    ...
                    <label className="flex items-center gap-3 p-3 bg-[#0D0D0D] rounded-lg border border-[#2D2D2D] cursor-pointer hover:border-yellow-500/50 transition-colors">
                      <input
                        type="radio"
                        name="adminType"
                        value="owner"
                      ...
                      />
                      <div className="flex-1">
                        <p className="text-white font-medium">👑 Proprietário (Owner)</p>
                        <p className="text-xs text-gray-500">
