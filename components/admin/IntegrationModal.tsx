  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-[#1A1A1A] border-[#2D2D2D] text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Configurar WhatsApp (Z-API)</DialogTitle>
          <p className="text-sm text-gray-400 mt-1">
            Empresa: <span className="text-white font-medium">{companyName}</span>
          </p>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <div className="space-y-6 py-4">
            ...
            {/* Agent Selector */}
            <div className="space-y-2">
              <Label htmlFor="agent_id" className="text-sm font-medium flex items-center gap-2">
            ...
            {/* Instance ID */}
            <div className="space-y-2">
              <Label htmlFor="instance_id" className="text-sm font-medium">
                Instance ID
              </Label>
              <Input
                id="instance_id"
                ...
                className="bg-[#0D0D0D] border-[#2D2D2D] text-white"
              />
              <p className="text-xs text-gray-500">ID da instância no painel Z-API</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-[#0D0D0D] border-[#2D2D2D] text-white pr-10"
                />
                <button
                  type="button"
            ...
            {/* Client Token */}
            <div className="space-y-2">
              <Label htmlFor="client_token" className="text-sm font-medium">
            ...
            {/* Active Switch */}
            <Card className="bg-[#0D0D0D] border-[#2D2D2D] p-4">
            ...
            <Card className="bg-[#0D0D0D] border-[#2D2D2D] p-4">
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">Buffer de Mensagens</h3>
                  <p className="text-xs text-gray-500">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <Label htmlFor="buffer_enabled" className="text-sm font-medium cursor-pointer">
                      Habilitar Buffer
                    </Label>
                    <p className="text-xs text-gray-500">
                ...
                {formData.buffer_enabled && (
                  <div className="space-y-2">
                    <Label htmlFor="buffer_debounce" className="text-sm font-medium">
                      Debounce (segundos)
                    </Label>
                    <Input
                      id="buffer_debounce"
                ...
                {formData.buffer_enabled && (
                  <div className="space-y-2">
                    <Label htmlFor="buffer_max_wait" className="text-sm font-medium">
                      Max Wait (segundos)
                    </Label>
                    <Input
                      id="buffer_max_wait"
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-[#2D2D2D]">
              <Button
                ...
                className="bg-transparent border-[#2D2D2D] text-gray-400 hover:text-white"
                disabled={saving}
              >
                Cancelar
              </Button>
