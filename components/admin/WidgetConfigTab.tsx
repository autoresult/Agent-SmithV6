      ...
      <div className="space-y-6">
        <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
          ...
          <CardContent className="space-y-4">
            <div>
              <Label className="text-gray-300">Título do Chat</Label>
              <Input
                value={config.title || ''}
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-12 h-10 p-1 bg-[#1A1A1A] border-[#3D3D3D] cursor-pointer"
                />
                <Input
                  value={config.primaryColor || '#2563EB'}
                  onChange={(e) => updateConfig('primaryColor', e.target.value)}
                  className="flex-1 bg-[#1A1A1A] border-[#3D3D3D] text-white font-mono"
                  placeholder="#2563EB"
                />
              </div>
            </div>
            ...
            <div>
              <Label className="text-gray-300">Mensagem Inicial</Label>
              <Input
        ...
        <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
          <CardHeader>
            <CardTitle className="text-sm text-white">🔧 Código de Instalação</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="bg-[#111] p-3 rounded-md border border-[#333] relative group">
              <pre className="text-xs text-green-400 whitespace-pre-wrap break-all font-mono overflow-x-auto">
                {embedCode}
              </pre>
              <Button
                size="icon"
            ...
            <p className="text-xs text-gray-500 mt-2">
              ...
              <code className="bg-[#333] px-1 rounded">&lt;/body&gt;</code> do seu site.
            </p>
          </CardContent>
        </Card>
      </div>
