...
export const LLM_MODEL_OPTIONS = [
  // =============================================================================
  // ANTHROPIC - Claude Models (Dez 2025)
  // =============================================================================

  // --- Claude 4.5 Series (Latest - Nov/2025) ---
  {
    label: 'Claude Opus 4.5 (Premium - Nov 2025)',
  ...
  {
    label: 'Claude Sonnet 4.5 (Recomendado - Set 2025)',
  ...
  // --- Aliases Anthropic ---
  {
    label: 'Claude Opus 4.5 (Alias)',
    value: 'claude-opus-4-5',
    group: 'Anthropic',
    description: 'Alias versão mais recente',
  },
  {
    label: 'Claude Sonnet 4.5 (Alias)',
  ...
  // --- Gemini 3 Series (Nov 2025 - Latest) ---
  {
    label: 'Gemini 3 Pro (Mais Inteligente)',
    value: 'gemini-3-pro-preview',
    group: 'Google',
    description: 'Modelo mais poderoso, SOTA em reasoning.',
    pricing: 'Preview',
  },
  {
...
export function AgentConfigModal({ companyId, agentId, open, onOpenChange }: Props) {
  ...
  const loadModels = (provider: string) => {
    // Filtra localmente baseado no provider
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto bg-[#1A1A1A] border-[#2D2D2D]">
        <DialogHeader>
        ...
        {loading ? (
          ...
          <Tabs defaultValue="identity" className="w-full">
            <div className="space-y-1 bg-[#2D2D2D] p-1 rounded-md">
              <TabsList className="grid w-full grid-cols-5 bg-transparent h-auto gap-1">
                <TabsTrigger
                  value="identity"
                  className="text-white data-[state=active]:bg-blue-600 data-[state=active]:text-white text-xs py-2"
                >
                  Identidade
                </TabsTrigger>
                <TabsTrigger
                ...
                <TabsTrigger
                  value="security"
                  className="text-white data-[state=active]:bg-red-600 data-[state=active]:text-white text-xs py-2 flex items-center gap-1"
                >
              ...
              <TabsList className="grid w-full grid-cols-5 bg-transparent h-auto gap-1">
                <TabsTrigger
                  value="tools"
                  className="text-white data-[state=active]:bg-purple-600 data-[state=active]:text-white text-xs py-2"
                >
                  HTTP Tools
                </TabsTrigger>
                <TabsTrigger
                  value="mcp"
                  className="text-white data-[state=active]:bg-orange-600 data-[state=active]:text-white text-xs py-2"
                >
                  MCP
                </TabsTrigger>
                <TabsTrigger
                  value="commerce"
                  className="text-white data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs py-2"
                >
                  Commerce
                </TabsTrigger>
                <TabsTrigger
                  value="widget"
                  className="text-white data-[state=active]:bg-cyan-600 data-[state=active]:text-white text-xs py-2"
                >
                  Widget
                </TabsTrigger>
                <TabsTrigger
                  value="whatsapp"
                  className="text-white data-[state=active]:bg-emerald-600 data-[state=active]:text-white text-xs py-2"
                >
                  WhatsApp
                </TabsTrigger>
              </TabsList>
            ...
            <TabsContent value="identity" className="space-y-6 mt-6">
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Identificação do Agente</CardTitle>
                </CardHeader>
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-white">Detectar Jailbreak</Label>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-white">Bloquear NSFW/Tóxico</Label>
                            <p className="text-xs text-gray-500">
                    ...
                    <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                              <Label className="text-white">Proteger Dados Pessoais</Label>
                              <p className="text-xs text-gray-500">
                          ...
                          {piiAction !== 'off' && (
                            <div className="space-y-2 animate-in fade-in slide-in-from-top-1">
                              <Label className="text-xs text-gray-400">Ação ao detectar</Label>
                              <Select value={piiAction} onValueChange={setPiiAction}>
                                <SelectTrigger className="bg-[#1A1A1A] border-[#3D3D3D] text-white h-8 text-xs">
                                  <SelectValue />
                                </SelectTrigger>
                                <SelectContent className="bg-[#1A1A1A] border-[#3D3D3D] text-white">
                        ...
                        <div className="flex items-center justify-between pt-2">
                          <div className="space-y-0.5">
                            <Label className="text-white">Bloquear Secret Keys</Label>
                            <p className="text-xs text-gray-500">
                        ...
                        <div className="flex items-center justify-between pt-2">
                          <div className="space-y-0.5">
                            <Label className="text-white">Bloquear se IA Falhar (Fail-Close)</Label>
                            <p className="text-xs text-gray-500">
                  ...
                  <div className="space-y-6">
                    <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-white">Proteção de URLs</Label>
                            <p className="text-xs text-gray-500">
                        ...
                        >
                          <div>
                            ...
                            <Label
                              htmlFor="url-off"
                              className="flex flex-col items-center justify-between rounded-md border-2 border-[#3D3D3D] bg-[#1A1A1A] p-4 hover:bg-[#2D2D2D] hover:text-white peer-data-[state=checked]:border-blue-500 [&:has([data-state=checked])]:border-blue-500 cursor-pointer"
                            >
                              <Globe className="mb-3 h-6 w-6 text-gray-400 peer-data-[state=checked]:text-blue-400" />
                              <span className="text-xs text-gray-300">Desativado</span>
                            </Label>
                          </div>
                          ...
                          <div>
                            ...
                            <Label
                              ...
                              className="flex flex-col items-center justify-between rounded-md border-2 border-[#3D3D3D] bg-[#1A1A1A] p-4 hover:bg-[#2D2D2D] hover:text-white peer-data-[state=checked]:border-blue-500 [&:has([data-state=checked])]:border-blue-500 cursor-pointer"
                            >
                              <Shield className="mb-3 h-6 w-6 text-gray-400 peer-data-[state=checked]:text-green-400" />
                              <span className="text-xs text-gray-300">Whitelist</span>
                            </Label>
                          </div>
                          ...
                          <div>
                            ...
                            <Label
                              ...
                              className="flex flex-col items-center justify-between rounded-md border-2 border-[#3D3D3D] bg-[#1A1A1A] p-4 hover:bg-[#2D2D2D] hover:text-white peer-data-[state=checked]:border-blue-500 [&:has([data-state=checked])]:border-blue-500 cursor-pointer"
                            >
                              <Lock className="mb-3 h-6 w-6 text-gray-400 peer-data-[state=checked]:text-red-400" />
                              <span className="text-xs text-gray-300">Blacklist</span>
                            </Label>
                          </div>
                        </RadioGroup>
                        ...
                        {urlMode === 'whitelist' && (
                          <div className="space-y-2 pt-2 animate-in fade-in slide-in-from-top-2">
                            ...
                            <Textarea
                              ...
                              className="bg-[#1A1A1A] border-[#3D3D3D] text-white text-xs font-mono h-24"
                            />
                        ...
                        <div className="space-y-2 pt-2">
                          <Label className="text-white">Tópicos Permitidos (Opcional)</Label>
                          <Textarea
                            value={allowedTopics}
                            onChange={(e) => setAllowedTopics(e.target.value)}
                            placeholder="Vendas, Suporte Técnico, Preços..."
                            className="bg-[#1A1A1A] border-[#3D3D3D] text-white text-xs h-20"
                          />
                          <p className="text-[10px] text-gray-500">
                    ...
                    <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-2">
                          <Label className="text-white">Mensagem ao Usuário</Label>
                          <Input
                        ...
                        <div className="space-y-2 pt-2">
                          ...
                          <Textarea
                            ...
                            className="bg-[#1A1A1A] border-[#3D3D3D] text-white text-xs font-mono h-16"
                          />
                        </div>
                      </CardContent>
                    </Card>
            ...
            <TabsContent value="model" className="space-y-6 mt-6">
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Modelo de IA</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <Button
                      ...
                      className="bg-[#1A1A1A] border-[#3D3D3D] text-white hover:bg-[#2D2D2D]"
                    >
                      {testingLLM ? (
                        <>
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Parâmetros</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <div>
                    <Label htmlFor="max_tokens" className="text-gray-300">
                      Max Tokens
                    </Label>
                    <Input
                      id="max_tokens"
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Parâmetros Avançados</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                  ...
                  <div>
                    <Label htmlFor="top_k" className="text-gray-300">
                      Top K
                    </Label>
                    <Input
                      id="top_k"
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <Label className="text-gray-300">Frequency Penalty</Label>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <Label className="text-gray-300">Presence Penalty</Label>
              ...
              {(llmModel?.startsWith('o1') || llmModel?.startsWith('o3')) && (
                <Card className="bg-[#2D2D2D] border-[#3D3D3D] border-purple-500/30">
                  <CardHeader>
                    <CardTitle className="text-sm text-white flex items-center gap-2">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <Label className="text-gray-300">Reasoning Effort</Label>
            ...
            <TabsContent value="personality" className="space-y-6 mt-6">
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Avatar do Agente</CardTitle>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <CardContent>
                  <div className="flex items-center gap-6">
                    {agentId ? (
                      ...
                      <div className="h-24 w-24 rounded-full bg-[#1A1A1A] border-2 border-[#3D3D3D] flex items-center justify-center">
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">System Prompt</CardTitle>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <CardContent className="space-y-2">
                  ...
                  {!isCreateMode && contextVars.length > 0 && (
                    <div className="flex justify-end">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-[#1A1A1A] border-[#3D3D3D]">
                          {contextVars.map((v) => (
                            <DropdownMenuItem
                              key={v.tag}
                  ...
                  <Textarea
                    ...
                    rows={10}
                    className="bg-[#1A1A1A] border-[#3D3D3D] text-white font-mono text-sm resize-y min-h-[200px]"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                <CardHeader>
                  <CardTitle className="text-sm text-white">Ferramentas Disponíveis</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {/* Web Search */}
                  <div className="flex items-center justify-between">
                  ...
                  <div className="border-t border-[#3D3D3D] pt-4 mt-4">
                    ...
                    {allowVision && (
                      <div className="mt-4 pt-4 border-t border-[#3D3D3D]/50 space-y-4">
                        <div>
                          <Label htmlFor="vision_model" className="text-gray-300 text-sm">
                            🤖 Modelo de Visão
                          </Label>
                          <Select value={visionModel || ''} onValueChange={setVisionModel}>
                            <SelectTrigger className="bg-[#1A1A1A] border-[#3D3D3D] text-white mt-2">
                              <SelectValue placeholder="Selecione o modelo de visão" />
                            </SelectTrigger>
                            <SelectContent className="bg-[#1A1A1A] border-[#3D3D3D]">
                              <SelectItem value="gpt-4o" className="text-white hover:bg-[#2D2D2D]">
                                GPT-4o (OpenAI)
                              </SelectItem>
                              <SelectItem
            ...
            <TabsContent value="tools" className="space-y-6 mt-6">
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                ...
                <CardContent>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label className="text-white">Busca Profunda (HyDE)</Label>
                      <p className="text-xs text-gray-400">
                ...
                <Card className="bg-yellow-900/20 border-yellow-600/50">
                  <CardContent className="pt-4">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ Salve o agente primeiro antes de configurar ferramentas HTTP.
                    </p>
                  </CardContent>
                </Card>
              ) : toolsView === 'list' ? (
                  ...
                  {loadingTools ? (
                    ...
                    <div className="space-y-3">
                      {httpTools.map((tool) => (
                        <Card
                          key={tool.id}
                          className="bg-[#0D0D0D] border-[#2D2D2D] hover:border-blue-600/50 transition-colors"
                        >
            ...
            <TabsContent value="mcp" className="space-y-6 mt-6">
              {isCreateMode ? (
                <Card className="bg-yellow-900/20 border-yellow-600/50">
                  <CardContent className="pt-4">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ Salve o agente primeiro antes de configurar integrações MCP.
                    </p>
                  </CardContent>
                </Card>
              ) : (
            ...
            <TabsContent value="commerce" className="space-y-6 mt-6">
              {isCreateMode ? (
                <Card className="bg-yellow-900/20 border-yellow-600/50">
                  <CardContent className="pt-4">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ Salve o agente primeiro antes de configurar integrações de comércio.
                    </p>
                  </CardContent>
                </Card>
              ) : (
            ...
            <TabsContent value="widget" className="space-y-6 mt-6">
              {isCreateMode ? (
                <Card className="bg-yellow-900/20 border-yellow-600/50">
                  <CardContent className="pt-4">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ Salve o agente primeiro antes de configurar o Widget.
                    </p>
                  </CardContent>
                </Card>
              ) : (
            ...
            <TabsContent value="whatsapp" className="space-y-6 mt-6">
              ...
              {isCreateMode && (
                <Card className="bg-yellow-900/20 border-yellow-600/50">
                  <CardContent className="pt-4">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ Salve o agente primeiro antes de configurar a integração WhatsApp.
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="bg-[#2D2D2D] border-[#3D3D3D]">
                        ...
                        <SelectItem value="z-api" className="text-white">
                          Z-API
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  {hasExistingIntegration && whatsappProvider !== 'none' && (
                    <div className="p-3 bg-orange-900/20 border border-orange-600/50 rounded-md">
              ...
              {whatsappProvider === 'z-api' && !isCreateMode && (
                <>
                  ...
                  <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                    <CardHeader>
                      <CardTitle className="text-sm text-white">Credenciais Z-API</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      {/* Telefone */}
                      <div>
                        <Label className="text-gray-300">Telefone Conectado *</Label>
                        <Input
                      ...
                      {/* Instance ID */}
                      <div>
                        <Label className="text-gray-300">Instance ID *</Label>
                        <Input
                      ...
                      {/* Client Token */}
                      <div>
                        <Label className="text-gray-300">Client Token (Opcional)</Label>
                        <div className="relative">
                          <Input
                  ...
                  <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                    <CardHeader>
                      <CardTitle className="text-sm text-white">Buffer de Mensagens</CardTitle>
                      <p className="text-xs text-gray-500">
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <Label className="text-gray-300">Habilitar Buffer</Label>
                          <p className="text-xs text-gray-500">Reduz chamadas de LLM em ~80%</p>
                        </div>
                        <Switch
                      ...
                      {whatsappBufferEnabled && (
                        <>
                          <div>
                            <Label className="text-gray-300">Debounce (segundos)</Label>
                            <Input
                              type="number"
                              min={1}
                              max={30}
                          ...
                          <div>
                            <Label className="text-gray-300">Max Wait (segundos)</Label>
                            <Input
                              type="number"
                              min={5}
                              max={60}
                  ...
                  <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
                    <CardContent className="pt-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <Label className="text-gray-300">Integração Ativa</Label>
                          <p className="text-xs text-gray-500">Habilita recebimento de mensagens</p>
                        </div>
