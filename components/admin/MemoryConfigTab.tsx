    ...
    <div className="space-y-6">
      ...
      <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
        ...
        <CardContent className="space-y-4">
          <div>
            <Label className="text-gray-300">Modo de Sumarização</Label>
            <Select
            ...
            >
              ...
              <SelectContent className="bg-[#2D2D2D] border-[#3D3D3D]">
                <SelectItem value="sliding_window" className="text-white">
                  Janela Deslizante (Recomendado)
                </SelectItem>
                <SelectItem value="message_count" className="text-white">
                  Contagem de Mensagens
                </SelectItem>
                <SelectItem value="time_based" className="text-white">
                  Baseado em Tempo
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          {settings.whatsapp_summarization_mode === 'sliding_window' && (
            <div>
              <Label className="text-gray-300">Tamanho da Janela (mensagens)</Label>
              <Input
                type="number"
      ...
      <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
        <CardHeader>
          ...
          <p className="text-xs text-gray-500 mt-1">Configurações de memória para chat web</p>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <Label className="text-gray-300">Modo de Sumarização</Label>
            ...
            >
              ...
              <SelectContent className="bg-[#2D2D2D] border-[#3D3D3D]">
                <SelectItem value="session_end" className="text-white">
                  Fim da Sessão (Padrão)
                </SelectItem>
                <SelectItem value="message_count" className="text-white">
                  Contagem de Mensagens
                </SelectItem>
                <SelectItem value="inactivity" className="text-white">
                  Inatividade
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-gray-300">Extrair Perfil do Usuário</Label>
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-gray-300">Gerar Resumo de Sessão</Label>
              <p className="text-xs text-gray-500">
      ...
      <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
        ...
        <CardContent className="space-y-4">
          ...
          {debugData && (
            <div className="bg-[#1A1A1A] border border-[#3D3D3D] rounded-lg p-4 max-h-[400px] overflow-auto">
