...
import { Bot, Edit, Archive, CheckCircle, XCircle } from 'lucide-react';
...
export function AgentCard({ agent, onEdit, onArchive }: AgentCardProps) {
  return (
    <Card className="bg-[#1A1A1A] border-[#2D2D2D] hover:border-blue-500/50 transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/10">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">/{agent.slug}</p>
            </div>
          </div>
