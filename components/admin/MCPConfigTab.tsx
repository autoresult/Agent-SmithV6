    ...
    <div className="space-y-6 mt-6">
      ...
      <Card className="bg-[#2D2D2D] border-[#3D3D3D]">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-sm text-white">Integrações MCP</CardTitle>
          <Button
            variant="ghost"
            size="sm"
            onClick={loadData}
        ...
        <CardContent className="space-y-3">
          {availableServers.length === 0 ? (
            <p className="text-gray-500 text-sm">Nenhum servidor MCP disponível</p>
          ) : (
                    ...
                    <div className="ml-4 flex gap-2">
                      ...
                      {status === 'not_configured' && (
                        <Button
                          ...
                          size="sm"
                          disabled
                          className="bg-[#2D2D2D] border-gray-600 text-gray-500"
                        >
                          Indisponível
                        </Button>
                      )}
                      ...
                      {status === 'disconnected' && server.oauth_provider && (
                        <Button
                          ...
                          className="bg-[#2D2D2D] border-blue-600 text-blue-400 hover:bg-blue-900/30"
                        >
                      ...
                      {status === 'connected' && (
                        <>
                          <Button
                            ...
                            className="bg-[#2D2D2D] border-green-600 text-green-400 hover:bg-green-900/30"
                          >
