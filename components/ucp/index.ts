    ...
    for (const pattern of jsonPatterns) {
      ...
      if (match && match.index !== undefined) {
        ...
        if (jsonStr) {
          ...
          // Fallback: Se encontrou o início do JSON mas não o fim (truncado),
          // removemos tudo do início do match até o final do texto para limpar visualmente.
          // Isso evita mostrar `{"type": ...` quebrado na tela.
          console.warn('[UCP Parser] Detected truncated JSON start, stripping artifact.');
