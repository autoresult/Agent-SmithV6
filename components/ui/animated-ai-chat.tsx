...
export function AnimatedAIChat({
  ...
  return (
    <div className="w-full relative">
      <motion.div
        className="relative backdrop-blur-2xl bg-white/[0.02] rounded-2xl border border-white/30 shadow-2xl"
        initial={{ scale: 0.98 }}
        animate={{ scale: 1 }}
      ...
      >
        ...
        <div className="p-4 border-t border-white/30 flex items-center justify-between gap-4">
          ...
          {showWebSearch && onToggleWebSearch && (
            <motion.button
              ...
              className={cn(
                ...
                allowWebSearch
                  ? 'text-blue-400 bg-blue-500/20 ring-2 ring-blue-500/30'
          ...
          {agents.length > 0 && onAgentChange && (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 transition-all"
              >
              ...
              <div
                id="agent-dropdown"
                className="hidden absolute bottom-full mb-2 left-0 min-w-[180px] py-1 rounded-xl bg-[#1a1a1a] border border-white/10 shadow-xl z-50"
              >
                {agents.map((agent) => (
                  <button
                    key={agent.id}
